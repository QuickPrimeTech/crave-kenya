      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs text-muted-foreground">{siteConfig.subtitle}</span>
          </div>
              ...
              <SheetContent side="right" className="w-72 bg-card border-border">
                <div className="flex flex-col gap-6 mt-8">
                  ...
                  <div className="pt-4 border-t border-border">
                    ...
                    <p className="text-sm text-foreground font-medium">{siteConfig.restaurant.location}</p>
                    <p className="text-xs text-muted-foreground mt-3 mb-2">Hours</p>
                    <p className="text-sm text-foreground">{siteConfig.restaurant.hours.weekday}</p>
                  </div>
                </div>
              </SheetContent>
            </Sheet>
