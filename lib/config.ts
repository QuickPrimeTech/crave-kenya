export const siteConfig = {
  name: 'CRAVE',
  subtitle: 'KILIMANI',
  description: 'Experience exceptional cuisine at Crave Kenya Kilimani. Premium dining with carefully crafted dishes in an elegant atmosphere.',
  ...
  social: {
    ...
    google: 'https://google.com/maps?sca_esv=a02f3e9b87f4a5a7&output=search&q=crave+kenya',
  },
  ...
  testimonials: [
    ...
    },
    {
      ...
      image: '👩‍✈️',
      content: 'A culinary gem in Nairobi. The flavors are bold, authentic, and beautifully presented.',
      fullReview: 'I travel extensively and taste cuisine from various cultures, and I can confidently say that Crave Kenya Kilimani represents the very best of contemporary Kenyan gastronomy. The restaurant celebrates local ingredients and traditional cooking techniques while embracing modern culinary arts. The sea urchin prepared with cassava root was revelatory, and the grass-fed beef with indigenous vegetables was simply divine. This is not fusion food for its own sake; it\'s thoughtful cooking that honors heritage while pushing boundaries. If you\'re visiting Nairobi, this is an absolute must-visit.',
      rating: 5,
      date: '3 days ago',
      verified: true,
    },
